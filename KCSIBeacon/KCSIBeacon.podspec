Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of KCSIBeacon in Markdown format.
  ...
  s.source       = { :git => "https://github.com/KinveyLabs/KCSIBeacon.git", :commit => "e88bcc02a9d8544377cabff2dfb01b984772c110" }
